...
(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
			// AMD
			define(['underscore', 'big-integer'], factory);
	} else if (typeof exports === 'object') {
			// Node, CommonJS-like
			module.exports = factory(require('underscore'), require('big-integer'));
	} else {
			// Browser globals (root is window)
			root.returnExports = factory(root._, root.bigInt);
	}
}(this, function (_, bigInt) {
